...
for (const user of usersList) {
    ...
    userGeo.appendChild(userGeoLat);
    userGeo.appendChild(userGeoLng);

    userAddress.appendChild(userStreet);
    userAddress.appendChild(userSuite);
    userAddress.appendChild(userCity);
    userAddress.appendChild(userZipcode);
    userAddress.appendChild(userGeo);

    userCompany.appendChild(companyName);
    userCompany.appendChild(companyCatchPhrase);
    userCompany.appendChild(companyBs);

    oneUser.appendChild(userId);
    oneUser.appendChild(userName);
    oneUser.appendChild(userEmail);
    oneUser.appendChild(userUsername);
    oneUser.appendChild(userAddress);
    oneUser.appendChild(userPhone);
    oneUser.appendChild(userWebsite);
    oneUser.appendChild(userCompany);

    userListElement.appendChild(oneUser);
